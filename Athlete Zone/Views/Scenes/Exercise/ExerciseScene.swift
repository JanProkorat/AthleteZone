                ...
                ActivityPicker(
                    ...
                    picker: AnyView(
                        TimePicker(
                            ...
                            interval: self.viewModel.selectedWorkOut.work
                        )
                ...
                ActivityPicker(
                    ...
                    picker: AnyView(
                        TimePicker(
                            ...
                            interval: self.viewModel.selectedWorkOut.rest
                        )
                        .onValueChange { value in
                ...
                ActivityPicker(
                    ...
                    picker: AnyView(
                        NumberPicker(
                            ...
                            value: self.viewModel.selectedWorkOut.series
                        )
                        .onValueChange { value in
                ...
                ActivityPicker(
                    ...
                    picker: AnyView(
                        NumberPicker(
                            ...
                            value: self.viewModel.selectedWorkOut.rounds
                        )
                        .onValueChange { value in
                ...
                ActivityPicker(
                    ...
                    picker: AnyView(
                        TimePicker(
                            ...
                            interval: self.viewModel.selectedWorkOut.reset
                        )
                        .onValueChange { value in
